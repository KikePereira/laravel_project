...
@section('content')
<div class="container">
    <form action="{{ route('cuota.store') }}" method="post" class="">
        ...
        <div class="row mt-3">
            ...
            @enderror
            <input type="text" class="form-control" name="concepto" placeholder="Concepto de la cuota" value="{{old('concepto')}}">
            </div>
            <!-- Fecha Emision -->
            <div class="col-12 col-lg-6">
                ...
                <span class="text-danger">{{ $message }}</span>
            @enderror
            <input type="date" class="form-control" name="fecha_emision" placeholder="Fecha Emision de la cuota" value="{{old('fecha_emision')}}">
            </div>
            <!-- Importe -->
            <div class="col-12 col-lg-6 mt-2">
                ...
                <span class="text-danger">{{ $message }}</span>
            @enderror
            <input type="text" class="form-control" name="importe" placeholder="Importe de la cuota" value="{{old('importe')}}">
            </div>
            <!-- Estado -->
            <div class="col-12 col-lg-6 mt-2">
            ...
            <div class="col-12 col-lg-6 mt-2">
                ...
                <span class="text-danger">{{ $message }}</span>
            @enderror
            <input type="date" class="form-control" name="fecha_pago" placeholder="Fecha Pago de la cuota" value="{{old('fecha_pago')}}">
            </div>
            ...
            <div class="col-12 mt-2">
                ...
                <span class="text-danger">{{ $message }}</span>
                @enderror
                <textarea name="notas" id="" cols="30" rows="10" class="form-control" placeholder="Añadir notas sobre la cuota">{{old('notas')}}</textarea>
            </div>
            ...
            <div class="col-12 col-lg-6 mt-2">
                ...
                <span class="text-danger">{{ $message }}</span>
            @enderror
            <input type="text" class="form-control" name="direccion" placeholder="Direccion de la cuota" value="{{old('direccion')}}">
            </div>
        </div>
