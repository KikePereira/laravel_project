    ...
    <form action="{{ route('tarea.update', $tarea)}}" method="post" class="">
        ...
        <div class="row">
            ...
            <div class="col-12 col-lg-4">
                ...
                <input type="text" class="form-control" name="nombre" placeholder="Nombre persona de contacto" value="{{ $tarea->nombre }}">
            </div>
            <!-- APELLIDO -->
            <div class="col-12 col-lg-4">
                <label for=""  class="form-label">Apellidos:</label> @error('apellidos')<span class="text-danger">{{$message}}</span>@enderror
                <input type="text" class="form-control" name="apellidos" placeholder="Apellido persona de contacto" value="{{ $tarea->apellidos }}">
            </div>
        </div>
        <br>
        <!-- CONTACTO -->
        <div class="row">
            <div class="col-12 col-lg-6">
                ...
                <input type="text" class="form-control" name="telefono" placeholder="Telefono persona de contacto" value="{{ $tarea->telefono }}">
            </div>
            <div class="col-12 col-lg-6">
                <label for=""  class="form-label">E-mail:</label> @error('correo')<span class="text-danger">{{$message}}</span>@enderror
                <input type="text" class="form-control" name="correo" placeholder="Correo Electronico persona de contacto" value="{{ $tarea->correo }}">
            </div>
        </div>
        <br>
        <!-- DESCRIPCION -->
        ...
        <div class="row">
            <div class="col-12">
                ...
                <textarea class="form-control" placeholder="Escribe aqui las anotaciones que creas necesarias para guiar y ayudar a los operarios." name="descripcion">{{ $tarea->descripcion }}</textarea>
            </div>
        </div>
        <br>
        <!-- DIRECCION -->
        ...
        <div class="row">
            <div class="col-12 col-lg-7">
                ...
                <input type="text" class="form-control" name="direccion" placeholder="Direccion" value="{{ $tarea->direccion }}">
            </div>
            <div class="col-12 col-lg-5">
                <label for=""  class="form-label">Codigo Postal:</label> @error('zip')<span class="text-danger">{{$message}}</span>@enderror
                <input type="text" class="form-control" name="zip" placeholder="Codigo Postal" value="{{ $tarea->zip }}">
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-12 col-lg-6">
                ...
                <input type="text" class="form-control" name="poblacion" placeholder="Poblacion" value="{{ $tarea->poblacion }}">
            </div>

            <div class="col-12 col-lg-6">
                <label for=""  class="form-label">Provincia:</label> @error('provincia')<span class="text-danger">{{$message}}</span>@enderror
                <input type="text" class="form-control" name="provincia" placeholder="Provincia" value="{{ $tarea->provincia }}">
            </div>
        </div>
        <br>
            <!-- EMPLEADO Y CLIENTE-->
        ...
        <div class="row">
            ...
            <div class="col-12 col-lg-4">
                ...
                <input type="date" class="form-control" name="fecha_realizacion" value="{{ $tarea->fecha_realizacion }}">
            </div>

            <div class="col-12 col-lg-4">
                <label for="" class="form-label">Fecha Finalizacion:</label> @error('fecha_finalizacion')<span class="text-danger">{{$message}}</span>@enderror
        ...
        <div class="row">
            <div class="col-12 col-lg-6">
                <label for="" class="form-label"> Anotaciones Inicio:</label> @error('anotacion_inicio')<span class="text-danger">{{$message}}</span>@enderror
                <textarea class="form-control" placeholder="Escribe aqui las anotaciones que creas necesarias para guiar y ayudar a los operarios." name="anotacion_inicio">{{ $tarea->anotacion_inicio }}</textarea>
            </div>

            <div class="col-12 col-lg-6">
                <label for="" class="form-label"> Anotaciones Final:</label> @error('anotacion_final')<span class="text-danger">{{$message}}</span>@enderror
                <textarea class="form-control" placeholder="Escribe aqui las anotaciones que creas necesarias para guiar y ayudar a los operarios." name="anotacion_final">{{ $tarea->anotacion_final }}</textarea>
            </div>
